...
### 1. Define models — `chores/models.py`
...
### 3. Seed the 3 People via a data migration
...
### 5. Implement views — `chores/views.py`
...
### 6. Templates — `chores/templates/chores/`
...
### 7. Register admin — `chores/admin.py`
